...
def test_new_files_do_not_use_forbidden_network_or_trading_tokens() -> None:
    paths = [
        ...
        REPO_ROOT / "ops" / "preflight_kr_end_to_end_intake.py",
        REPO_ROOT / "ops" / "validate_kr_end_to_end_preflight_plan.py",
        REPO_ROOT / "ops" / "build_kr_end_to_end_handoff_manifest.py",
        REPO_ROOT / "ops" / "verify_kr_end_to_end_handoff_manifest.py",
    ]
    forbidden = (
        "requests",
        "httpx",
