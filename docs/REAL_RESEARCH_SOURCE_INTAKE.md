...
**Next deferred step — 3H24+ (unimplemented)**

**3H24+** — end-to-end hardening (calibration, drift checks, richer provenance) remains deferred. Broker/PaperLoop/KIS integration remains out of scope for Real Research Source Intake.
