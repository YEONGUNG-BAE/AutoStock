...
| 구현 상태 | **1A–2B + 3A + 3A.1 + 3B1 + 3B2 + 3C1 + 3C2** (DART corp_code resolver + live master fetch); combined smoke verified; provider registry / universe real-company migration deferred |
