...
| 구현 상태 | **1A–2B + 3A + 3A.1 + 3B1 + 3B2 + 3C1 + 3C2 + 3D1 + 3E1 + 3E2 + 3E3 + 3E4 + 3F1 + 3F2 + 3G1 + 3G2 + 3G3-0 + 3G3-1 + 3G3-2 + 3G3-3 + 3G3-4A + 3G3-4B + 3G3-5 + 3G3-6 + 3G4-0** (factor scoring guardrail checkpoint, docs-only); **3G4-1+** fixture-first factor scoring deferred; **3G3-6+** source-specific live adapter hardening deferred |

- **3G4-0 factor scoring guardrail checkpoint** is documented. Factor scoring remains advisory metadata only; fixture-first implementation is deferred to 3G4-1.
