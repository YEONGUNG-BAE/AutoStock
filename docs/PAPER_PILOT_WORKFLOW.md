...
| 구현 상태 | **1A–2B + 3A + 3A.1 + 3B1 + 3B2 + 3C1 + 3C2 + 3D1 + 3E1 + 3E2 + 3E3** (KR real sample live DART disclosure smoke via provider mapping); **3E4+** combined FRED+PRICE+DART live context + 3–5 company expansion deferred |
