...
| 구현 상태 | **1A–2B + 3A + 3A.1 + 3B1 + 3B2 + 3C1 + 3C2 + 3D1 + 3E1** (static KR real-company sample universe: Samsung Electronics + SK hynix); **3E2+** live combined smoke + 3–5 company expansion deferred |
