...
- Real Intake **3B1** — DART live snapshot normalizer + fake HTTP transport tests (fixture-first; no real network; snapshot→3A replay→8B validate-only; collision + no-leak guards).
