...
- Real Intake **3E4+** — combined FRED+PRICE+DART live context; expand to 3–5 real companies after live corp-code snapshot verification, provider auto-generation, sector/universe discovery — deferred.
