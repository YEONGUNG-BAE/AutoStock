...
from domain.enums import AccountRole, AssetClass, Market, OrderSide, OrderStatus, OrderType
...
class OrderIntent(BaseModel):
    ...
    def validate_order_intent(self) -> Self:
        ...
        if not has_quantity and not has_target_weight:
            raise ValueError("OrderIntent requires quantity or target_weight_percent.")
